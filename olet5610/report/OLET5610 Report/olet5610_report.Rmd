...
```{r loadplot, fig.cap = "Loadings of each variable onto the eight retained principal components.", fig.width = 7, echo = FALSE, warning = FALSE, message = FALSE}
