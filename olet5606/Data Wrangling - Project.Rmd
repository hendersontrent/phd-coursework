...
Recent empirical research has sought to combine the ideas of finding empirical structure in data as a means to classify time series. This approach has meaningful practical significance as data-driven classification tasks become even more prominent in the rapidly growing availability of time series data. Examples include classifying schizophrenic from control using signals from an electroencephalogram, star type using light-curves, and customer segmentation based on clicks on a webpage. Stakeholders for this type of work are far reaching, including customers, patients, medical practitioners, researchers, and C-suite executives, among many others.
